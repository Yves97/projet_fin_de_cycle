...
if (isset($_SESSION['id'])) {
    ...
    if(isset($_POST['annee']) && !empty($_POST['annee'])){
        $request = $connection->prepare("INSERT INTO annee_scolaire(annee) VALUES (?)");
        $res = $request->execute([$_POST['annee']]);
    }
    ...
    <div class="container" style="margin-top:-5vh;">
        <div class="row justify-content-center">
            <div class="col-12 col-md-8 col-lg-6 pb-5">
                <!--Form with header-->
                <form action="" method="post" class="animated fadeInLeft">
                    <div class="card border-light rounded-0">
                        <div class="card-header p-0">
                            <div class=" text-black text-center py-2">
                                <h3><i class="fa fa"></i>Nouvelle Annee scolaire</h3>
                                <small>ajouter une nouvelle annee scolaire</small>
                            </div>
                        </div>
            ...
            <div class="col-12 col-md-8 col-lg-6 pb-5">
                ...
                <form action="" method="post" class="animated fadeInLeft">
                    <div class="card border-light rounded-0">
                        <div class="card-header p-0">
                            <div class=" text-black text-center py-2">
                                <h3><i class="fa fa"></i>Annee scolaire</h3>
