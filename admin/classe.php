...
if (isset($_SESSION['id'])) {
    ...
    if(isset($_POST['classe']) && !empty($_POST['classe'])){
        $request = $connection->prepare("INSERT INTO classe(nom_classe) VALUES (?)");
        $res = $request->execute([$_POST['classe']]);
    }
    $classe = $connection->query('SELECT * FROM classe');
                    ...
                    <div class="card border-light rounded-0">
                        <div class="card-header p-0">
                            <div class=" text-black text-center py-2">
                                <h3><i class="fa"></i>Nouvelle classe</h3>
                                <small>ajouter une nouvelle classe</small>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-2">
                                        <select name="classe" id="" class="form-control">
                                            <option value="LOGISTIQUE1">LOGISTIQUE1</option>
                                            <option value="RH-COM1">RH-COM1</option>
                                            <option value="MARKETING1">MARKETING1</option>
                                            <option value="AUDIT1">AUDIT1</option>
                                            <option value="ELECTRONIQUE1">ELECTRONIQUE1</option>
                                            <option value="GESTION COMMERCIALE1">GESTION COMMERCIALE1</option>
                                        </select>
                                    </div>
                                </div>
            ...
            <div class="col-12 col-md-8 col-lg-6 pb-5">
                ...
                <form action="" method="post" class="animated fadeInDown">
                    <div class="card border-light rounded-0">
                        <div class="card-header p-0">
                            <div class=" text-black text-center py-2">
                                <h3><i class="fa "></i>Liste des classes</h3>
